...
// Log functions. Not meant to be called directly
bool _log_should_log(enum LogLevel level);
...
#define LOG_TRACE_FUNC(fmt, ...) \
    LOG_BODY(LOG_LEVEL_TRACE, "%s:%d %s() " fmt, __FILENAME__, __LINE__, __func__, ##__VA_ARGS__)
